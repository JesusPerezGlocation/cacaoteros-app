 ...
 return Scaffold(
  ...
  body: FadeIn(
    child: ListView(
      ...
      children: [
          const TitleSurveysComponents(title:'PRÁCTICAS DE MANEJO DEL CULTIVO > INFORMACIÓN DE FERTILIZACIÓN' ), 
        ...
        if( controller.text.isNotEmpty && controller.text =='Si')
          ...
          Animate(
            ...
            child: DropdownComponents(
                ...
                initialValue: '-', 
                hintext: ' Seleccionar dato', 
                items:const ['Al suelo', 'Foliar', 'Orgánica (Compost)', 'Otro'], 
                validator: (value) => ValidationInputs.inputTypeSelect(value),
                onChanged: (val){
                },
              ),
        ...
        if( controller.text.isNotEmpty && controller.text =='Si')
          ...
          Animate(
            ...
            child: DropdownComponents(
                ...
                initialValue: '-', 
                hintext: ' Seleccionar dato', 
                items:const ['Enero', 'Febrero','Marzo','Abril','Mayo','Junio','Julio','Agosto','Septiembre','Octubre','Noviembre','Diciembre'], 
                validator: (value) => ValidationInputs.inputTypeSelect(value),
                onChanged: (val){
                },
              ),
