 ...
 return Scaffold(
  ...
  body: FadeIn(
    child: ListView(
        ...
        children: [
          const TitleSurveysComponents(title:'CARACTERISTICAS DE LA VIVIENDA'), 
        ...
        if( typeHouse.text.isNotEmpty && typeHouse.text =='Otro') SizedBox(height: size.height*.04),
        ...
        if( typeCeiling.text.isNotEmpty && typeCeiling.text =='Otro') SizedBox(height: size.height*.04),
        if( typeCeiling.text.isNotEmpty && typeCeiling.text =='Otro')
          ...
          Animate(
           ...
           DropdownComponents(
             ...
             items:const ['Bloque', 'Madera','Madera','Placa prefabiricada','Otro'], 
             validator: (value) => ValidationInputs.inputTypeSelect(value),
             onChanged: (val){   
                setState(()=> wallsCeiling.text = val.toString());
             },
           ),
        if( wallsCeiling.text.isNotEmpty && wallsCeiling.text =='Otro') SizedBox(height: size.height*.04),
        if( wallsCeiling.text.isNotEmpty && wallsCeiling.text =='Otro')
          ...
          SizedBox(height: size.height*.04),
           ...
           DropdownComponents(
             ...
             items:const ['Convencional', 'Letrina','Pozo séptico','No tiene'], 
             validator: (value) => ValidationInputs.inputTypeSelect(value),
             onChanged: (val){   
          ...
          SizedBox(height: size.height*.04),
           ...
           DropdownComponents(
             ...
             initialValue: 'CC', 
             hintext: ' Seleccionar dato', 
             items:const ['Bota al patio', 'Entierra','Quema','Recolección'], 
             validator: (value) => ValidationInputs.inputTypeSelect(value),
             onChanged: (val){   
          ...
          SizedBox(height: size.height*.04),
           ...
           DropdownComponents(
             ...
             initialValue: 'CC', 
             hintext: ' Seleccionar dato', 
             items:const ['Electrico','Gas','Gasolina','Leña',], 
             validator: (value) => ValidationInputs.inputTypeSelect(value),
             onChanged: (val){   
          ...
          SizedBox(height: size.height*.04),
           ...
           DropdownComponents(
             ...
             initialValue: 'CC', 
             hintext: ' Seleccionar dato', 
             items:const ['Bionergía','Gasolina','Red eléctrica','Solar',], 
             validator: (value) => ValidationInputs.inputTypeSelect(value),
             onChanged: (val){   
