 ...
 return Scaffold(
  ...
  body: FadeIn(
    child: ListView(
      ...
      children: [
        const TitleSurveysComponents(title:'INFORMACIÓN BÁSICA DEL CACAOCULTOR > INFORMACIÓN SOCIAL'), 
        ...
        SizedBox(height: size.height*.04),
         ...
         SizedBox(height: size.height*.03),
            ...
            DropdownComponents(
              ...
              items:const ['MUJER CABEZA DE FAMILIA', 'ADULTO MAYOR', 'VÍCTIMA DE VIOLENCIA','PERSONA EN SITUACIÓN DE DISCAPACIDAD','NINGUNA'], 
              validator: (value) => ValidationInputs.inputTypeSelect(value),
              onChanged: (val){     
              },
            ),
         SizedBox(height: size.height*.03),
            ...
            DropdownComponents(
              ...
              items:const ['AFRODESCENDIENTE', 'GITANO', 'RAIZAL','INDÍGENA','NINGUNA'], 
              validator: (value) => ValidationInputs.inputTypeSelect(value),
              onChanged: (val){     
              },
            ),
