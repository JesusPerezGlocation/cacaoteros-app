    ...
    child: ListView(
     ...
     DropdownComponents(
      ...
      onChanged: (val){ 
        ...
        if (economic.text.isNotEmpty && economic.text=='Otro') SizedBox(height: size.height*.03) else const SizedBox(),
    //#6 economica
     if (economic.text.isNotEmpty && economic.text=='Otro') Animate(
