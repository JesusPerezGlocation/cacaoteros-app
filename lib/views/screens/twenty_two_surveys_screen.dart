 ...
 return Scaffold(
  ...
  body: FadeIn(
    child: ListView(
          ...
          //#01
            InputsComponent(
              title: 'Nombre organizaciones que lo han apoyado en su cultivo de cacao', 
           ...
           SizedBox(height: size.height*.04),
            //#02
            DropdownComponents(
                title: ' Mayor limitante en su finca para para mejorar su cultivo',
                initialValue: '-', 
                hintext: ' Seleccionar dato', 
                items:const ['Agua', 'Capital de trabajo (\$)','Conocimiento técnico','Inseguridad','Mano de obra','Precio de venta','Vías de acceso','Otro',], 
                validator: (value) => ValidationInputs.inputTypeSelect(value),
                onChanged: (val){
                  setState(()=> controller.text = val.toString());
                },
              ),
        if( controller.text.isNotEmpty && controller.text =='Otro') SizedBox(height: size.height*.04),
        ...
        // #3
          ...
          ButtonComponents(
           ...
           onPressed: (){
            ...
            Navigator.pushNamed(context, MainRoutes.twentyThreeSurveysRoute);
