...
const TwentyThreeSurveysScreen({super.key});
  ...
  @override
  State<TwentyThreeSurveysScreen> createState() => _TwentyThreeSurveysScreenState();
}
 ...
 return Scaffold(
  ...
  body: FadeIn(
    child: ListView(
          ...
          children: [
           ...
           SizedBox(height: size.height*.04),
            ...
            DropdownComponents(
                ...
                items:const ['Administración','Familiar','Propietario',], 
        ...
        if( controller.text.isNotEmpty && controller.text =='Familiar') SizedBox(height: size.height*.04),
        ...
        /*check */
         CheckbuttonComponent(
          ...
          check: false,
          onPressed: ()=> TermAndConditionsShowModal.showModalAuthorization(context),
          ),
