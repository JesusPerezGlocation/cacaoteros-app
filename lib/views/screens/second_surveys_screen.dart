...
class _SecondSurveysScreenState extends State<SecondSurveysScreen> {
 ...
 return Scaffold(
  ...
  body: FadeIn(
   ...
   if (nacionality.text.isNotEmpty && nacionality.text!='Colombiano') SizedBox(height: size.height*.03) else const SizedBox(),
    // #10 nacionalidad
    if (nacionality.text.isNotEmpty && nacionality.text!='Colombiano') Animate(
