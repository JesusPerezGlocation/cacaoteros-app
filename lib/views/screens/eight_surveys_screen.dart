...
class _EightSurveysScreenState extends State<EightSurveysScreen> {
 ...
 body: FadeIn(
   child: ListView(
      ...
      children: [
        const TitleSurveysComponents(title:'INFORMACIÓN BÁSICA DEL CACAOCULTOR > INFORMACIÓN DE PROYECTOS'), 
      ...
      if( proyect.text.isNotEmpty && proyect.text =='Si') SizedBox(height: size.height*.04),
