        ...
        Animate(
         ...
         SizedBox(height: size.height*.04),
          ...
          DropdownComponents(
              ...
              initialValue: '-', 
              hintext: ' Seleccionar dato', 
              items:const ['Bosque primario', 'Bosque secundario','Galería','Ninguno'], 
              validator: (value) => ValidationInputs.inputTypeSelect(value),
              onChanged: (val){
              },
            ), 
         ...
         SizedBox(height: size.height*.04),
          ...
          DropdownComponents(
              ...
              initialValue: '-', 
              hintext: ' Seleccionar dato', 
              items:const ['Agroforestal', 'Agroforestal con especie nativa','Agriturístico','Observación fauna y flora'], 
              validator: (value) => ValidationInputs.inputTypeSelect(value),
              onChanged: (val){
              },
            ),
