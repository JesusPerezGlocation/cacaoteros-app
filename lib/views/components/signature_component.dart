...
const SignatureComponents({super.key});
    ...
    child: Column(
      children: [
         ...
         Row(
          ...
          'Ingresar firma',
          maxLines: 1,
          style: Theme.of(context).textTheme.titleMedium!.copyWith(color: PaletteColorsTheme.principalColor), 
          ...
          const Spacer(),
           ...
           OutlinedButton(onPressed: (){
            SnackBarGlobalWidget.showSnackBar(context, 'Firma guardada con éxito!', Icons.check_circle_outline_outlined, PaletteColorsTheme.principalColor);
           }, 
