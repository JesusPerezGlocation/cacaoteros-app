  ...
  child: ListView(
    ...
    children: [
      ...
      Padding(
        ...
        child: Text(
          'Para todos los efectos, certifico que los datos por mí suministrados en la presente encuesta, son veraces. Habeas data: en cumplimiento de la ley 1581 de 2012 y el decreto 1377 de 2013, con la firma de este documento, autorizo a la Federación Nacional de Cacaoteros para mantener y manejar la información contenida en esta encuesta para los fines de caracterización de cacaocultores en desarrollo de los programas y proyectos desarrollados en Fedecacao.',
          maxLines: 10,
