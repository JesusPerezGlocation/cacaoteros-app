...
class AppBarMainTheme {
  ...
  static AppBarTheme appbarLight = AppBarTheme(
    iconTheme:const IconThemeData(color: PaletteColorsTheme.principalColor, size: 25),
    actionsIconTheme:const IconThemeData(color: PaletteColorsTheme.principalColor, size: 25),
